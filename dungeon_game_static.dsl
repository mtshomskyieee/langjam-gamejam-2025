init:
    ...
    npc:
        npc-static: unique_name="wizard" place at (10, 10) response "By the ancient runes!|The arcane forces whisper secrets.|Mystical energies flow through this place.|The stars align in mysterious ways.|Magic pulses in the very air.|The old spells still hold power here.|Wisdom comes to those who seek it.|The crystal ball reveals all.|Through the veil of time, I see.|The mystical arts never fade."
...
end_game:
    if user talked to wizard then win the game
